  ...
  return (
    <div style={{ maxWidth: '600px', margin: 'auto', padding: '20px' }}>
      <Form name="create-survey" onFinish={onFinish} layout="vertical">
            ...
            <Row gutter={16}>
              <Col span={24}>
                <Form.Item
                  ...
                  rules={[{ required: true, message: `Please enter question ${questionIndex + 1}` }]}
                >
                  <Input
              ...
              {question.options.map((option, optionIndex) => (
                <Col span={24} key={optionIndex}>
                  <Form.Item
                    ...
                    rules={[{ required: true, message: `Please enter option ${optionIndex + 1}` }]}
                  >
                    <Input
        ...
        <Button type="dashed" onClick={handleAddQuestion} style={{ marginTop: '20px' }}>
          Add Question
        </Button>
